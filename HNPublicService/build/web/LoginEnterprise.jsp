<%-- 
    Document   : LoginEnterprise
    Created on : Oct 25, 2023, 8:33:37 PM
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="LoginEnterprise.css">
    ...
    <body>
        <div class="box">
            <div class="container">
                ...
                <div class="top">
                    <header>HNPS Enterprise Login</header>
                </div>

                <form method="post" action="Login">

                    <div class="input-field">
                        <input type="text" class="input" placeholder="Enter citizen identification card" id="" name="email" value="${email}">
